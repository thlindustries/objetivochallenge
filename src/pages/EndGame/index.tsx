...
import { Container, EndGameMessageContainer, StyledParticles } from './styles';
        ...
        <EndGameMessageContainer>
          ...
          <span>
            <p>
              ...
              terem participado deste desafio Fiquem ligados em seus e-mails que
              em breve o resultado final será divulgado
            </p>
